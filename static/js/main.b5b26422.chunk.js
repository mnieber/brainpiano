...
var react_router = __webpack_require__(232);

// EXTERNAL MODULE: ./node_modules/history/esm/history.js + 2 modules
var esm_history = __webpack_require__(45);
...
var QuizFrame = __webpack_require__(135);
...
var react_default_props_context = __webpack_require__(24);
...
var mathMod=function mathMod(m,p){if(!Number.isInteger(m)){return NaN;}if(!Number.isInteger(p)||p<1){return NaN;}return(m%p+p)%p;};
...
var GroupsFrame = __webpack_require__(138);
...
var GroupsFrameTopPanel = __webpack_require__(139);
...
var GroupsFrameLeftPanel = __webpack_require__(155);
...
var use_deep_compare_effect_esm = __webpack_require__(131);
...
// EXTERNAL MODULE: ./node_modules/ramda/es/pipe.js + 2 modules
var pipe = __webpack_require__(229);

// EXTERNAL MODULE: ./node_modules/ramda/es/always.js
var always = __webpack_require__(222);

// EXTERNAL MODULE: ./node_modules/ramda/es/range.js
...
function noteValueToColour(noteValue,clef,chord){var _head;var harmonicColour=Object(includes["a" /* default */])(noteValue,chord)?noteColours[keyConstants_noteValueToIndex(noteValue-clefOffsets[clef])]:undefined;var isStriped=!!(harmonicColour&&harmonicColour.endsWith('-striped'));var colour=isStriped?(_head=Object(head["a" /* default */])(Object(split["a" /* default */])('-striped',harmonicColour!==null&&harmonicColour!==void 0?harmonicColour:'')))!==null&&_head!==void 0?_head:'':harmonicColour;return{colour:colour,isStriped:isStriped};}
// CONCATENATED MODULE: ./src/keyboard/components/Octave.tsx
var Octave=Object(es["a" /* observer */])(function(props){var keyIndexes=Object(concat["a" /* default */])(whiteKeyIndexes,blackKeyIndexes);var keys=Object(pipe["a" /* default */])(Object(always["a" /* default */])(keyIndexes),Object(map["a" /* default */])(Object(add["a" /* default */])(octaveRootNoteValue(props.index))),Object(map["a" /* default */])(function(noteValue){var keyIndex=keyConstants_noteValueToIndex(noteValue);var _noteValueToColour=noteValueToColour(noteValue,props.clef,props.chord),colour=_noteValueToColour.colour,isStriped=_noteValueToColour.isStriped;return/*#__PURE__*/Object(jsx_runtime["jsx"])(Key,{index:keyIndex,octaveIndex:props.index,markerColour:colour,markerIsStriped:isStriped,scaleFactor:props.scaleFactor},noteValue);}))();return/*#__PURE__*/Object(jsx_runtime["jsx"])(ReactKonva["a" /* Layer */],{children:keys});});
// EXTERNAL MODULE: ./node_modules/react-swipeable/dist/react-swipeable.umd.js
var react_swipeable_umd = __webpack_require__(126);

// EXTERNAL MODULE: ./node_modules/audiosynth/index.js
var audiosynth = __webpack_require__(125);
var audiosynth_default = /*#__PURE__*/__webpack_require__.n(audiosynth);

// CONCATENATED MODULE: ./src/voicings/utils/playChord.ts
var AudioContext=window.AudioContext||window.webkitAudioContext;var context=new AudioContext();var synth=new audiosynth_default.a(context);var playChord_playChord=function playChord(chord,clef){chord.forEach(function(note,idx){return window.setTimeout(function(){synth.playNote(note+48,0.5,0.75,0);},200+idx*150);});synth.playNote(clefOffsets[clef]+36,1.0,1.0,0);};
// CONCATENATED MODULE: ./src/voicings/components/InversionSelector.tsx
var InversionSelector=Object(es["a" /* observer */])(function(p){var props=Object(react_default_props_context["b" /* useDefaultProps */])(p);var _useStore=useStore_useStore(),voicingStore=_useStore.voicingStore;var swipeHandlers=Object(react_swipeable_umd["useSwipeable"])({onSwipedLeft:function onSwipedLeft(eventData){return invertLeft(voicingStore,props.quizState.query);},onSwipedRight:function onSwipedRight(eventData){return invertRight(voicingStore,props.quizState.query);},preventDefaultTouchmoveEvent:true,trackMouse:false});return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_keyboard_event_handler_default.a,{handleKeys:['ctrl+left','ctrl+right'],onKeyEvent:function onKeyEvent(key,e){if(key==='ctrl+right'){invertRight(voicingStore,props.quizState.query);}if(key==='ctrl+left'){invertLeft(voicingStore,props.quizState.query);}},children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react_keyboard_event_handler_default.a,{handleKeys:['p'],onKeyEvent:function onKeyEvent(key,e){if(voicingStore.chord){playChord_playChord(voicingStore.chord,voicingStore.clef);}},children:/*#__PURE__*/Object(jsx_runtime["jsx"])("div",Object(objectSpread2["a" /* default */])(Object(objectSpread2["a" /* default */])({},swipeHandlers),{},{children:props.children}))})});});function invertRight(voicingStore,query){voicingStore.setInversion(voicingStore.inversion+1);if(query){query.inversion=voicingStore.inversion;}}function invertLeft(voicingStore,query){voicingStore.setInversion(voicingStore.inversion-1);if(query){query.inversion=voicingStore.inversion;}}
...
var Keyboard_Keyboard=Object(es["a" /* observer */])(function(p){var props=Object(react_default_props_context["b" /* useDefaultProps */])(p);var _useStore=useStore_useStore(),voicingStore=_useStore.voicingStore,clefStore=_useStore.clefStore,scaleFactor=_useStore.scaleFactor;var octaves=Object(pipe["a" /* default */])(Object(always["a" /* default */])(Object(range["a" /* default */])(0,4)),Object(map["a" /* default */])(function(i){return/*#__PURE__*/Object(jsx_runtime["jsx"])(Octave,{index:i,clef:clefStore.clef,chord:voicingStore.chord,scaleFactor:scaleFactor},i);}))();return/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"Keyboard__frame",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(RandomChordSelector,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(ClefSelector,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(ClefModulationSelector,{children:/*#__PURE__*/Object(jsx_runtime["jsxs"])(InversionSelector,{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"Keyboard__overlay absolute z-50",style:{height:250*scaleFactor,width:1400*scaleFactor},onClick:props.onClick,tabIndex:0}),/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(ReactKonva["c" /* Stage */],{width:1400*scaleFactor,height:250*scaleFactor,children:octaves})})]})})})})});});
// EXTERNAL MODULE: ./src/keyboard/components/ClefListView.scss
var ClefListView = __webpack_require__(195);

// CONCATENATED MODULE: ./src/keyboard/components/ClefListView.tsx
var ClefListView_ClefListView=Object(es["a" /* observer */])(function(p){var props=Object(react_default_props_context["b" /* useDefaultProps */])(p);var clefDivs=Object(pipe["a" /* default */])(Object(always["a" /* default */])(props.clefs),Object(map["a" /* default */])(function(x){return/*#__PURE__*/Object(jsx_runtime["jsx"])(ClefListViewItem_ClefListViewItem,{clef:x,className:classnames_default()({'ClefListViewItem--selected':props.clefsSelection.ids.includes(x)}),onMouseDown:function onMouseDown(e){props.clefsSelection.selectItem({itemId:x,isShift:false,isCtrl:true});}},x);}))();var noItems=/*#__PURE__*/Object(jsx_runtime["jsx"])("h2",{children:"There are no clefs"});return/*#__PURE__*/Object(jsx_runtime["jsxs"])("div",{className:classnames_default()('ClefListView flex flex-row w-full',props.className),children:[clefDivs.length&&clefDivs,!clefDivs.length&&noItems]});});
// EXTERNAL MODULE: ./src/keyboard/components/ClefListViewItem.scss
var ClefListViewItem = __webpack_require__(196);
...
var parse_parseVoicing=function parseVoicing(data){var voicing=Object(objectSpread2["a" /* default */])(Object(objectSpread2["a" /* default */])({},data),{},{id:data.name,chord:Object(map["a" /* default */])(function(x){var noteValue=valueByNoteName[x];if(noteValue===undefined){console.log("Error: unknown note ".concat(x));}return noteValue;},data['chord'])});for(var i=1;i<voicing.chord.length;++i){while(voicing.chord[i]<=voicing.chord[i-1]){voicing.chord[i]+=12;}}return voicing;};var parse_parseVoicingGroup=function parseVoicingGroup(data){return Object(objectSpread2["a" /* default */])(Object(objectSpread2["a" /* default */])({},data),{},{id:data.name,voicings:Object(map["a" /* default */])(parse_parseVoicing,data['voicings'])});};var cache={data:null};var parse_parseVoicingGroups=function parseVoicingGroups(data){cache.data=data;return Object(map["a" /* default */])(parse_parseVoicingGroup,data);};
// EXTERNAL MODULE: ./node_modules/@trendmicro/react-buttons/dist/react-buttons.css
var react_buttons = __webpack_require__(206);

// EXTERNAL MODULE: ./node_modules/@trendmicro/react-dropdown/dist/react-dropdown.css
var react_dropdown = __webpack_require__(207);

// EXTERNAL MODULE: ./src/io/components/IoMenu.scss
var IoMenu = __webpack_require__(208);
...
var QuizFrameTopPanel = __webpack_require__(209);
...
var initializerDefineProperty = __webpack_require__(33);
...
var skandha_mobx = __webpack_require__(102);
...
var skandha_facets = __webpack_require__(76);
...
var skandha_facets_policies = __webpack_require__(101);

// EXTERNAL MODULE: ./node_modules/skandha-facets/Selection.js
var Selection = __webpack_require__(41);
...
// EXTERNAL MODULE: ./node_modules/ramda/es/sum.js
var sum = __webpack_require__(227);

// EXTERNAL MODULE: ./node_modules/ramda/es/length.js
var es_length = __webpack_require__(226);

// CONCATENATED MODULE: ./src/utils/random.ts
var random_randomElement=function randomElement(items){return items[Math.floor(Math.random()*Object(es_length["a" /* default */])(items))];};
// EXTERNAL MODULE: ./node_modules/ramda/es/take.js + 2 modules
var take = __webpack_require__(230);

// EXTERNAL MODULE: ./node_modules/ramda/es/takeLast.js + 2 modules
var takeLast = __webpack_require__(231);

// CONCATENATED MODULE: ./src/voicings/utils/invertChord.ts
var invertChord_invertChord=function invertChord(chord,pos){function rotate(arr){var maxNote=arr[arr.length-1];var first=Object(take["a" /* default */])(1,arr);var last=Object(takeLast["a" /* default */])(Object(es_length["a" /* default */])(arr)-1,arr);while(first[0]<=maxNote){first[0]+=12;}return Object(concat["a" /* default */])(last,first);}function rotateBack(arr){var minNote=arr[0];var last=Object(takeLast["a" /* default */])(1,arr);var first=Object(take["a" /* default */])(Object(es_length["a" /* default */])(arr)-1,arr);while(last[0]>=minNote){last[0]-=12;}return Object(concat["a" /* default */])(last,first);}var result=chord;for(var i=0;i<Math.abs(pos);i++){result=pos>0?rotate(result):rotateBack(result);}return result;};var getInversionRange=function getInversionRange(chord){var topC=48;var minInversion=0;var maxInversion=0;var l=chord.length;while(invertChord_invertChord(chord,maxInversion+1)[l-1]<topC){maxInversion+=1;}while(invertChord_invertChord(chord,minInversion-1)[0]>=0){minInversion-=1;}return[minInversion,maxInversion];};
// CONCATENATED MODULE: ./src/voicings/utils/voicingToChord.ts
var voicingToChord_voicingToChord=function voicingToChord(voicing,clef,octaveIndex){var rootNoteValue=octaveRootNoteValue(octaveIndex);var keyOffset=clefOffsets[clef];var result=Object(pipe["a" /* default */])(//
Object(always["a" /* default */])(voicing.chord),Object(map["a" /* default */])(Object(add["a" /* default */])(rootNoteValue+keyOffset)))();return result;};
// CONCATENATED MODULE: ./src/quiz/utils/createQuery.ts
var createQuery_getRandomInversion=function getRandomInversion(voicing,clef){var L=voicing.chord.length;var _getInversionRange=getInversionRange(voicingToChord_voicingToChord(voicing,clef,1)),_getInversionRange2=Object(slicedToArray["a" /* default */])(_getInversionRange,2),minInversion=_getInversionRange2[0],maxInversion=_getInversionRange2[1];var inversionRange=Object(range["a" /* default */])(minInversion,maxInversion+1).filter(function(x){return!voicing.inversions||voicing.inversions[mathMod(x,L)]!==false;});if(inversionRange.length===0){return 0;}var inversion=random_randomElement(inversionRange);// Try to bring inversion closer to zero using steps of voicing.chord.length inversions
// (which means its the same inversion, just at a different place on the keyboard)
while(inversion+L<=maxInversion&&Math.abs(inversion)>Math.abs(inversion+L)){inversion+=L;}while(inversion-L>=minInversion&&Math.abs(inversion)>Math.abs(inversion-L)){inversion-=L;}return inversion;};var createQuery_createQuery=function createQuery(clefs,groups){var clef=random_randomElement(clefs);var nrVoicings=Object(sum["a" /* default */])(Object(map["a" /* default */])(function(x){return x.voicings.length;})(groups));var voicingIdx=Math.floor(Math.random()*nrVoicings);var groupIdx=0;var count=groups[0].voicings.length;while(voicingIdx>=count){groupIdx+=1;count+=groups[groupIdx].voicings.length;}var group=groups[groupIdx];var voicing=group.voicings[voicingIdx-(count-group.voicings.length)];var inversion=createQuery_getRandomInversion(voicing,clef);return{clef:clef,group:group,voicing:voicing,inversion:inversion};};
...
var micro_signals_lib = __webpack_require__(128);
...
// EXTERNAL MODULE: ./node_modules/ramda/es/clamp.js
var clamp = __webpack_require__(228);

// CONCATENATED MODULE: ./src/voicings/VoicingStore.ts
var cScale=parse_parseVoicing({id:'Chromatic',name:'Chromatic',chord:['root','flat9','ninth','flat3','third','fourth','flat5','fifth','flat6','sixth','flat7','seventh']});var VoicingStore_VoicingStore=/*#__PURE__*/function(){function VoicingStore(){var _this=this;Object(classCallCheck["a" /* default */])(this,VoicingStore);this.clef='C';this.inversion=0;this.voicing=cScale;this.setInversion=function(x){_this.inversion=Object(clamp["a" /* default */])(_this.inversionRange[0],_this.inversionRange[1])(x);};this.setVoicing=function(voicing){_this.voicing=voicing;};Object(mobx_esm["h" /* makeObservable */])(this,{clef:mobx_esm["i" /* observable */],inversion:mobx_esm["i" /* observable */],voicing:mobx_esm["i" /* observable */],chord:mobx_esm["c" /* computed */],nrOfVoices:mobx_esm["c" /* computed */],inversionRange:mobx_esm["c" /* computed */],setInversion:mobx_esm["b" /* action */],setVoicing:mobx_esm["b" /* action */]});}Object(createClass["a" /* default */])(VoicingStore,[{key:"inversionRange",get:function get(){return getInversionRange(voicingToChord_voicingToChord(this.voicing,this.clef,1));}},{key:"nrOfVoices",get:function get(){return Object(es_length["a" /* default */])(this.voicing.chord);}},{key:"chord",get:function get(){return this.clef?invertChord_invertChord(voicingToChord_voicingToChord(this.voicing,this.clef,1),this.inversion):undefined;}}]);return VoicingStore;}();
...
//# sourceMappingURL=main.b5b26422.chunk.js.map